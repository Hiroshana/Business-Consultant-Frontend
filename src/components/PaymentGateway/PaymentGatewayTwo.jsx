                        ...
                        <div className='w-11/12 xl:w-7/12'>
                            <div className='right pl-10' style={{
                                ...
                                <div className='bg-img'>
                                    <Image width={5000} height={5000} className='w-full' src="/images/gateway2-bg.webp" alt="img" />
                                </div>
                                ...
                                <div className='feature-item py-4 px-6 rounded-2xl bg-white inline-flex items-center gap-4 box-shadow'>
                                    <i className='icon-user text-2xl bg-orange-300 p-4 rounded-2xl bg-red-600'></i>
                                    <div className='text'>
