            ...
            <div className='container'>
                <div className='heading flex  max-xl:flex-col xl:items-center gap-4 justify-between'>
                    ...
                    <div className='body3 text-secondary'>
                        Working with this agency has been a game-changer for our business forme ipsum dolor sit amet, co
                    </div>
                </div>
                <form className='form md:mt-10 mt-6 flex max-lg:flex-col lg:items-center justify-between gap-8 pb-14 border-b border-line'>
                    <div className='grid lg:grid-cols-3 gap-6 w-full'>
                        <div className='w-full'>
                            <input className='body3 md:py-[14px] py-3 px-5 bg-surface rounded-lg w-full bg-gray-100' type="text" name="name" placeholder='First name' />
                        </div>
                        <div className='w-full'>
                            <input className='body3 md:py-[14px] py-3 px-5 bg-surface rounded-lg w-full bg-gray-100' type="email" name="name" placeholder='Email' />
                        </div>
